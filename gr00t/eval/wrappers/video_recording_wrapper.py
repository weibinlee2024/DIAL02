...
class VideoRecordingWrapper(gym.Wrapper):
    ...
    # def reset(self, seed=None, options=None): # using standard reset signature
    #     print(f"video_recording_wrapper options: {options}")
    ...
    #         filename_prefix = options.get("video_filename_prefix", "")
    #         new_filestem = filename_prefix + original_filestem

    #         new_filestem = f"success{int(self.is_success)}_{new_filestem}"
