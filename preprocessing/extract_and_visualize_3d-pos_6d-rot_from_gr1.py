...
def process_demo(args, ep):
    ...
    # Initialize video writer (force FFMPEG backend: pyav backend in imageio 2.34 + av 12.x is broken)
    video_writer = imageio.get_writer(video_path, fps=20, format="FFMPEG", codec="libx264")
